	...
	)
{
    ...
    check_for_GL_errors( "glGenTextures test1" );
    ...
    check_for_GL_errors( "glGenTextures test2" );
    ...
    check_for_GL_errors( "glGenTextures test4" );
...
int query_NPOT_capability( void )
{
	...
	if( has_NPOT_capability == SOIL_CAPABILITY_UNKNOWN )
	{
        ...
        char const* tmp = (char const*)glGetString( GL_EXTENSIONS );
        check_for_GL_errors( "glGenTextures test3" );

		if(NULL == tmp || NULL == strstr(tmp, "GL_ARB_texture_non_power_of_two"))
		{
